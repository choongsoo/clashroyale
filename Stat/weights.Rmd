...
Each row (match) in training dataset gets a weight:
match weight = sqrt(sum(weights of cards used in match))
Match weights will be stored as row names.
...
Percentage of significant interaction terms in both joint models
