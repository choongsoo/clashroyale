...
How many interaction terms are actually significant in the joint model?
...
write(int_cond_joint, "int_lasso.txt")  # conditional joint model positive interactions
```

## Network

Build an adjacency list that represents this graph (network). This will be done in Python.
